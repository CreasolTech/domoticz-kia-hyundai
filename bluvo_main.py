...
def process_data(carstatus, location, odometer):
    ...
    try:
        ...
        googlelocation = '<a href="http://www.google.com/maps/search/?api=1&query=' + str(parsedstatus['loclat']) + ',' + str(
            parsedstatus['loclon']) + '">Kia eNiro - km from home</a>'
    ...
    if parsedstatus['chargeHV'] == 0:
        parsedstatus['chargeHV'] = 50   # default value: prevent battery soc going 0 for any error
